...
public class ResourcesHelper {
    ...
    public static Map<String, String> ICONS = new HashMap<String, String>() {{
        put("defaultPatientIconURL", "https://firebasestorage.googleapis.com/v0/b/medproject-d78df.appspot.com/o/icons%2Fpatient.png?alt=media&token=caa21916-390b-4396-8115-4b6d334c1591");
